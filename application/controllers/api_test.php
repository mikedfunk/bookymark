...
class api_test extends MY_Controller
{
	 ...
	 * api_base_url
	 * 
	 * (default value: 'http://bookymark.dev/')
	 * 
	 * @var string
	 * @access public
	 */
	 ...
	 * api_access_token
	 * 
	 * (default value: '4395dd07a3cfe84d9655bb2542907f3acd0024fe')
	 * 
	 * @var string
	 * @access public
	 */
	 ...
	 * api_shared_secret
	 * 
	 * (default value: '3c697e1314808f56bd44bc5ccb4765607b433715')
	 * 
	 * @var string
	 * @access public
	 */
	...
	public function index()
	{
		...
		var_dump($this->request_OLD('OPTIONS', 'bookmarks/id/1', $data));
	}
	...
	/**
	 * the old method. allows for calling OPTIONS.
	 * 
	 * @access protected
	 * @param mixed $method
	 * @param mixed $path
